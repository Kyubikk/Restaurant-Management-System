...
class CatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cate" do
    assert_difference("Cate.count") do
      post cates_url, params: { cate: { cate_name: @cate.cate_name, description: @cate.description } }
    end
  ...
  test "should update cate" do
    patch cate_url(@cate), params: { cate: { cate_name: @cate.cate_name, description: @cate.description } }
